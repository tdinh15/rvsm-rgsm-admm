...
ap('--dev', '--device', default=0, type=int, metavar='N', help='GPU to run on')
...
if __name__ == '__main__':
    ...
    checkpoint = torch.load('ckpt2_001.pth')

    basic_net = en_preactresnet20_cifar(num_ensembles=1, noise_coef=0)
    config = {
