...
ap('-dev', default=0, type=int, metavar='N', help='GPU to run on')
ap('-flname', default='admm-1pgd50', type=str, metavar='N', help='name of model file')
ap('-num_ensembles', '--ne', default=1, type=int, metavar='N')
...
if __name__ == '__main__':
    ...
    '''
    with open("fooled_ResNet_PGD_" + attack_type + str(int(1000*epsilon)) + ".pkl", "wb") as f:
        adv_data_dict = {
            "images" : images,
